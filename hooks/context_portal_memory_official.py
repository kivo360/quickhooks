...
class ContextPortalHook:
    ...
    def extract_context_info(self, tool_name: str, tool_input: Dict[str, Any], session_id: str) -> Dict[str, str]:
    ...
    def enhance_with_context(self, tool_name: str, tool_input: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """Enhance tool input with relevant context from memory."""
        # Search for relevant context
        if tool_name == 'Bash' and 'command' in tool_input:
            command = tool_input['command']
            relevant_context = self.memory_manager.search_context(tool_name="Bash", query=command, limit=3)
    ...
    def process_tool_usage(self, tool_name: str, tool_input: Dict[str, Any], session_id: str) -> Optional[Dict[str, Any]]:
...
def main():
    ...
    try:
        ...
        if enhanced_input:
            ...
            print(f"Context Portal: Enhanced {tool_name} with {len(enhanced_input.get('_context_portal_history', []))} context entries", file=sys.stderr)
