...
from quickhooks.cli.install import check_uv_available, get_uv_python_executable, get_python_executable
...
def test_uv_availability():
    ...
    if uv_available:
        ...
        if uv_python:
            ...
            import subprocess
            try:
                result = subprocess.run([str(uv_python), '--version'], capture_output=True, text=True, timeout=5)
