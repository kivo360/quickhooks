...
class DatabaseConfig(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_prefix="QUICKHOOKS_DATABASE_",
        case_sensitive=False
    )
    
    url: str = Field(
        default="sqlite:///./quickhooks.db",
...
class LoggingConfig(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_prefix="QUICKHOOKS_LOGGING_",
        case_sensitive=False
    )
...
class HookConfig(BaseSettings):
    ...
    hooks_directory: str = Field(
        default="./hooks",
        description="Directory containing hook implementations"
    )
    auto_discovery: bool = Field(
        default=True,
        description="Automatically discover hooks in the hooks directory"
    )
...
class DevelopmentConfig(BaseSettings):
    ...
    enable_testing: bool = Field(
        default=True,
        description="Enable testing features and endpoints"
    )
...
class QuickHooksConfig(BaseSettings):
    ...
    hooks: HookConfig = Field(
        ...
        description="Hook execution configuration"
    )
...
_config: Optional[QuickHooksConfig] = None
